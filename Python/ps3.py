...
def get_word_score(word, n):
    ...
    total2 = 7 * word_length - 3 * (n - word_length)
    word = word.lower()
    ...
    while calculate_handlen(hand) > 0:
        ...
        if word == '.':
            ...
            if is_valid_word(word, hand, word_list) == True :
                ...
                print(word, "points: ", get_word_score(word,n),"total: ", score, "\n" )
                hand = update_hand(word, hand )
            else:
                print("such word doesnt exist or you dont have right letters")
                break
        if word == '.':
            print("total score, goodbye", "score: ",score)
        else:
            print("no letters left", "score: ",score)
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    """
    while True:
        user_input = str(input("enter:\n  n - to deal a new hand\n r - to replay hand\n e - end current game"))
        print("play_game not implemented.") # TO DO... Remove this line when you implement this function
        if user_input == 'e':
            break
        elif user_input == 'n':
            hand = deal_hand(HAND_SIZE)
            playfulhand(hand,word_list,HAND_SIZE)
        elif user_input == 'r':
            try:
                play_hand(hand,word_list)
            except: print("please play your hand")
            else:
                print("??")
